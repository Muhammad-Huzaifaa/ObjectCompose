...
class StableDiffusionInpaintPipeline(
    ...
    def __call__(
        ...
        resized_mask = self.image_processor.postprocess(resized_mask, output_type=output_type, do_denormalize=[False] * resized_mask.shape[0])
        resized_masked_image = self.image_processor.postprocess(resized_masked_image, output_type=output_type, do_denormalize=do_denormalize)
        resized_orig_image = self.image_processor.postprocess(resized_orig_image, output_type=output_type, do_denormalize=do_denormalize)

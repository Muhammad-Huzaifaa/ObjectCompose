...
class FilteredCocoClassification(DatasetFolder):
...
if __name__ == "__main__":
    ...
    root = "coco_classification/images"
    dataset = FilteredCocoClassification(root, transform=transform, transform_mask=transform_mask, expansion_mask_pixels=None)
    # load dataloader
    import torch
